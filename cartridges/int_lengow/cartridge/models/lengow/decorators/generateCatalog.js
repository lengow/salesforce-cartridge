...
function generateCatalog() {
    ...
    var allowedLocales = collections.toArray(Site.getCurrent().getAllowedLocales());
    var lengowSeletedLocales = collections.toArray(Site.getCurrent().getCustomPreferenceValue('lengowSeletedLocales'));
